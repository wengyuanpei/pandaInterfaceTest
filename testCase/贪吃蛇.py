#!/usr/bin/env python
# -*- coding: utf-8 -*-
# author: Wang dali time:2021年1月20日16:08:44
# python实现&#xff1a;贪吃蛇
"""
...
def main():
    ...
    pygame.display.set_caption('贪吃蛇')  # Set the caption
    # 得分字体设置
            ...
            if curTime - last_move_time > speed:
                if not pause:
                    ...
                    if next_s == food:
                        ...
                        # 在区域内
                        if Area_x[0] <= next_s[0] <= Area_x[1] and Area_y[0] <= next_s[1] <= Area_y[1] \
